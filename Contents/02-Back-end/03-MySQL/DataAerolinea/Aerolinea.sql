...
-- -----------------------------------------------------
-- Table `aerolineasargentinas`.`Pasajeros`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `aerolineasargentinas`.`Pasajeros` (
  ...
  `AeropuertoSalida` VARCHAR(45) NULL,
  `Destino` VARCHAR(45) NULL,
  `TipoVuelo` ENUM("PrimeraClasse", "Turista") NULL,
  `PosicionAsiento` TINYINT UNSIGNED NULL,
  `Alergias` VARCHAR(45) NULL,
  `Edad` TINYINT UNSIGNED NULL,
  `Sexo` ENUM("H", "M") NULL,
  `DocumentId` ENUM("DNI", "PASSPORT") NULL,
  `NumeroDocumentoId` VARCHAR(45) NULL,
  `CodigoPromocional` VARCHAR(10) NULL,
  `TipoDePago` ENUM("VISA", "PAYPAL") NULL,
  `NumTargeta` TINYINT UNSIGNED NULL,
  PRIMARY KEY (`Id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `aerolineasargentinas`.`Reservas` (
  ...
  PRIMARY KEY (`Id`, `Pasajeros_Id`, `Vuelos_Id`, `Vuelos_Aviones_Id`),
  INDEX `fk_Reservas_Pasajeros(CLIENTES)_idx` (`Pasajeros_Id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Reservas_Pasajeros(CLIENTES)`
    ...
    REFERENCES `aerolineasargentinas`.`Pasajeros` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
